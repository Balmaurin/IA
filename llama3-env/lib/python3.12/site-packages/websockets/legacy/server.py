...
class WebSocketServerProtocol(WebSocketCommonProtocol):
    ...
    def __init__(
        ...
        *,
        ...
        process_request: Callable[[str, Headers], Awaitable[HTTPResponse | None]] | None = None,
        select_subprotocol: Callable[[Sequence[Subprotocol], Sequence[Subprotocol]], Subprotocol] | None = None,
    ...
    def close(self, close_connections: bool = True) -> None:
        ...
        * Wait until all connection handlers terminate.
        ...
        if self.close_task is None:
            self.close_task = self.get_loop().create_task(self._close(close_connections))
...
def unix_serve(
    # The version that accepts the path in the second argument is deprecated.
    ws_handler: (
        Callable[[WebSocketServerProtocol], Awaitable[Any]] | Callable[[WebSocketServerProtocol, str], Awaitable[Any]]
    ),
    path: str | None = None,
    **kwargs: Any,
) -> Serve:
