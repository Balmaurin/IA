...
class ServerProtocol(Protocol):
    ...
    def process_subprotocol(self, headers: Headers) -> Subprotocol | None:
        ...
        subprotocols: Sequence[Subprotocol] = sum(
            [parse_subprotocol(header_value) for header_value in headers.get_all("Sec-WebSocket-Protocol")],
            [],
        )
    ...
    def select_subprotocol(
        ...
        raise NegotiationError("invalid subprotocol; expected one of " + ", ".join(self.available_subprotocols))
