...
class Duration(timedelta):
    ...
    if PYPY:
        ...
        def total_seconds(self) -> float:
            ...
            return ((days * SECONDS_PER_DAY + self._seconds) * US_PER_SECOND + self._microseconds) / US_PER_SECOND
...
Duration.max = Duration(days=999999999, hours=23, minutes=59, seconds=59, microseconds=999999)
...
class AbsoluteDuration(Duration):
    ...
    def __new__(
        ...
        self = timedelta.__new__(cls, days, seconds, microseconds, milliseconds, minutes, hours, weeks)
