...
def local_time(unix_time: int, utc_offset: int, microseconds: int) -> tuple[int, int, int, int, int, int, int]:
    """
...
def precise_diff(d1: datetime.datetime | datetime.date, d2: datetime.datetime | datetime.date) -> PreciseDiff:
    """
    ...
    tzinfo1: datetime.tzinfo | None = d1.tzinfo if isinstance(d1, datetime.datetime) else None
    tzinfo2: datetime.tzinfo | None = d2.tzinfo if isinstance(d2, datetime.datetime) else None

    if (tzinfo1 is None and tzinfo2 is not None) or (tzinfo2 is None and tzinfo1 is not None):
    ...
    sec_diff = 0
    mic_diff = 0
    total_days = _day_number(d2.year, d2.month, d2.day) - _day_number(d1.year, d1.month, d1.day)
    in_same_tz = False
    tz1 = None
    tz2 = None
