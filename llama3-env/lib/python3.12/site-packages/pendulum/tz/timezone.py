...
class Timezone(zoneinfo.ZoneInfo, PendulumTimezone):
    ...
    def convert(self, dt: _DT, raise_on_unknown_times: bool = False) -> _DT:
        ...
        if dt.tzinfo is None:
            ...
            if offset_after > offset_before:
                ...
                dt = cast(
                    "_DT",
                    dt + ((offset_after - offset_before) if dt.fold else (offset_before - offset_after)),
                )
    ...
    def datetime(
        ...
        """
        return self.convert(_datetime.datetime(year, month, day, hour, minute, second, microsecond, fold=1))
