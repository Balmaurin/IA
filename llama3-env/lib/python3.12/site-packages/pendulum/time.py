...
class Time(FormattableMixin, time):
    ...
    @classmethod
    def instance(cls, t: time, tz: str | Timezone | FixedTimezone | datetime.tzinfo | None = UTC) -> Self:
        tz = t.tzinfo or tz
    ...
    def __repr__(self) -> str:
        ...
        return f"{self.__class__.__name__}" f"({self.hour}, {self.minute}, {self.second}{us}{tzinfo})"
    ...
    def add(self, hours: int = 0, minutes: int = 0, seconds: int = 0, microseconds: int = 0) -> Time:
        """
        ...
        return (
            ...
            .add(hours=hours, minutes=minutes, seconds=seconds, microseconds=microseconds)
            .time()
        )

    def subtract(self, hours: int = 0, minutes: int = 0, seconds: int = 0, microseconds: int = 0) -> Time:
        """
        Add duration to the instance.
        ...
        return (
            DateTime.EPOCH.at(self.hour, self.minute, self.second, self.microsecond)
            .subtract(hours=hours, minutes=minutes, seconds=seconds, microseconds=microseconds)
            .time()
        )
    ...
    def replace(
        ...
        return self.__class__(t.hour, t.minute, t.second, t.microsecond, tzinfo=t.tzinfo)

    def __getnewargs__(self) -> tuple[Time]:
        return (self,)

    def _get_state(self, protocol: SupportsIndex = 3) -> tuple[int, int, int, int, datetime.tzinfo | None]:
        tz = self.tzinfo
