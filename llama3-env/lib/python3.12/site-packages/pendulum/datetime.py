...
class DateTime(datetime.datetime, Date):
    ...
    def create(
        ...
        dt = datetime.datetime(year, month, day, hour, minute, second, microsecond, fold=fold)
    ...
    @classmethod
    def now(cls, tz: str | Timezone | FixedTimezone | datetime.tzinfo | None = None) -> Self:
        """
    ...
    def set(
        ...
        return self.__class__.create(year, month, day, hour, minute, second, microsecond, tz=tz, fold=self.fold)
    ...
    def at(self, hour: int, minute: int = 0, second: int = 0, microsecond: int = 0) -> Self:
        ...
        """
        return self.set(hour=hour, minute=minute, second=second, microsecond=microsecond)
    ...
    def is_long_year(self) -> bool:
        ...
        """
        return DateTime.create(self.year, 12, 28, 0, 0, 0, tz=self.tz).isocalendar()[1] == 53
    ...
    def is_anniversary(self, dt: datetime.datetime | None = None) -> bool:  # type: ignore[override]
        """
    ...
    def nth_of(self, unit: str, nth: int, day_of_week: WeekDay) -> Self:
        ...
        if not dt:
            raise PendulumException(
                f"Unable to find occurrence {nth}" f" of {WeekDay(day_of_week).name.capitalize()} in {unit}"
            )
    ...
    def _nth_of_month(self, nth: int, day_of_week: WeekDay | None = None) -> Self | None:
        """
    ...
    def _nth_of_quarter(self, nth: int, day_of_week: WeekDay | None = None) -> Self | None:
        """
        Modify to the given occurrence of a given day of the week
    ...
    def average(self, dt: datetime.datetime | None = None) -> Self:  # type: ignore[override]
        """
    ...
    def __sub__(self, other: datetime.datetime | datetime.timedelta) -> Self | Interval[datetime.datetime]:
