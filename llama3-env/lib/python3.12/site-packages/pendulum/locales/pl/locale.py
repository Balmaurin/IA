...
locale = {
    "plural": lambda n: (
        "few"
        if (
            ((0 == 0 and (0 == 0)) and ((n % 10) == (n % 10) and ((n % 10) >= 2 and (n % 10) <= 4)))
            ...
            if (
                (
                    ...
                    or ((0 == 0 and (0 == 0)) and ((n % 10) == (n % 10) and ((n % 10) >= 5 and (n % 10) <= 9)))
                )
                or ((0 == 0 and (0 == 0)) and ((n % 100) == (n % 100) and ((n % 100) >= 12 and (n % 100) <= 14)))
            )
            else "one" if ((n == n and (n == 1)) and (0 == 0 and (0 == 0))) else "other"
        )
    ),
