...
def _typer_param_setup_autocompletion_compat(
    ...
    *,
    autocompletion: Optional[Callable[[click.Context, List[str], str], List[Union[Tuple[str, str], str]]]] = None,
) -> None:
...
def _get_default_string(
    ...
    *,
    ...
    if show_default_is_str:
        ...
        default_string = ", ".join(
            _get_default_string(obj, ctx=ctx, show_default_is_str=show_default_is_str, default_value=d)
        ...
        # Typer override end
    elif isinstance(obj, TyperOption) and obj.is_bool_flag and not obj.secondary_opts and not default_value:
        default_string = ""
    else:
        default_string = str(default_value)
...
class TyperGroup(click.core.Group):
    def __init__(
        ...
        *,
        ...
        commands: Optional[Union[Dict[str, click.Command], Sequence[click.Command]]] = None,
        # Rich settings
        rich_markup_mode: MarkupMode = DEFAULT_MARKUP_MODE,
        rich_help_panel: Union[str, None] = None,
        **attrs: Any,
