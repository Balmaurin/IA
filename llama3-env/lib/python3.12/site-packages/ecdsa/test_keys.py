...
prv_key_bytes = b"^\xc8B\x0b\xd6\xef\x92R\xa9B\xe9\x89\x04<\xa2" b"\x9fV\x1f\xa5%w\x0e\xb1\xc5"
...
def test_SigningKey_sign_digest_deterministic(convert):
    sig = sk.sign_digest_deterministic(convert(data_hash), extra_entropy=convert(extra_entropy))
