...
def run_openssl(cmd):
    ...
    if p.returncode != 0:
        raise SubprocessError("cmd '%s %s' failed: rc=%s, stdout/err was %s" % (OPENSSL, cmd, p.returncode, stdout))
...
class ECDSA(unittest.TestCase):
    ...
    def assertTruePrivkeysEqual(self, priv1, priv2):
        self.assertEqual(priv1.privkey.secret_multiplier, priv2.privkey.secret_multiplier)
        self.assertEqual(
    ...
    def test_pubkey_strings(self):
        ...
        class FakeCurveFp:
            def p(self):
                return int("6525534529039240705020950546962731340" "4541085228058844382513856749047873406763")

        badcurve = Curve("unknown", FakeCurveFp(), FakeGenerator(), (1, 2, 3, 4, 5, 6), None)
    ...
    def test_sk_from_p8_der_with_wrong_version(self):
        ...
        privkey_der = der.encode_octet_string(
            der.encode_sequence(der.encode_integer(1), der.encode_octet_string(b"\x00\xff"))
        )
    ...
    def test_sk_from_p8_der_with_wrong_algorithm(self):
        ver_der = der.encode_integer(1)
        algorithm_der = der.encode_sequence(der.encode_oid(1, 2, 3), der.encode_oid(1, 2, 840, 10045, 3, 1, 1))
        privkey_der = der.encode_octet_string(
            der.encode_sequence(der.encode_integer(1), der.encode_octet_string(b"\x00\xff"))
        )
        to_decode = der.encode_sequence(ver_der, algorithm_der, privkey_der)
    ...
    def test_sk_from_p8_der_with_trailing_junk_after_key(self):
        ...
        privkey_der = der.encode_octet_string(
            der.encode_sequence(der.encode_integer(1), der.encode_octet_string(b"\x00\xff")) + der.encode_integer(999)
        )
    ...
    def test_hashfunc(self):
        ...
        vk3 = VerifyingKey.from_string(sk.get_verifying_key().to_string(), curve=NIST256p)
    ...
    def test_hybrid_decoding_with_inconsistent_encoding_and_no_validation(
        ...
        b = VerifyingKey.from_string(enc, valid_encodings=("hybrid",), validate_point=False)
...
@pytest.mark.parametrize("val,even", [(i, j) for i in range(256) for j in [True, False]])
...
class OpenSSL(unittest.TestCase):
    ...
    def do_test_from_openssl(self, curve, hash_name="SHA1"):
        ...
        run_openssl("pkcs8 -topk8 -nocrypt " "-in t/privkey.pem -outform pem -out t/privkey-p8.pem")
    ...
    def do_test_to_openssl(self, curve, hash_name="SHA1"):
        ...
        run_openssl("dgst %s -sign t/privkey-explicit.pem -out t/data.sig2 t/data.txt" % mdarg)
        run_openssl("dgst %s -verify t/pubkey.pem -signature t/data.sig2 t/data.txt" % mdarg)

        with open("t/privkey-p8.pem", "wb") as e:
            e.write(sk.to_pem(format="pkcs8"))
        run_openssl("dgst %s -sign t/privkey-p8.pem -out t/data.sig3 t/data.txt" % mdarg)
        run_openssl("dgst %s -verify t/pubkey.pem -signature t/data.sig3 t/data.txt" % mdarg)

        with open("t/privkey-p8-explicit.pem", "wb") as e:
            e.write(sk.to_pem(format="pkcs8", curve_parameters_encoding="explicit"))
        run_openssl("dgst %s -sign t/privkey-p8-explicit.pem -out t/data.sig3 t/data.txt" % mdarg)
        run_openssl("dgst %s -verify t/pubkey.pem -signature t/data.sig3 t/data.txt" % mdarg)
    ...
    try:
        if "-rawin" in run_openssl("pkeyutl -help"):
            OPENSSL_SUPPORTED_TYPES = set(  # pragma: no branch
                c.lower() for c in ("ED25519", "ED448") if c in run_openssl("list -public-key-methods")
            )
    ...
    def do_eddsa_test_to_openssl(self, curve):
        ...
        with self.assertRaises(SubprocessError):
            run_openssl("pkeyutl -verify -pubin -inkey t/pubkey.pem -rawin " "-in t/baddata.txt -sigfile t/data.sig")
        run_openssl("pkeyutl -verify -pubin -inkey t/pubkey.pem -rawin " "-in t/data.txt -sigfile t/data.sig")
    ...
    def do_eddsa_test_from_openssl(self, curve):
        ...
        run_openssl("genpkey -algorithm {0} -outform PEM -out t/privkey.pem".format(curvename))
        run_openssl("pkey -outform PEM -pubout -in t/privkey.pem -out t/pubkey.pem")

        with open("t/data.txt", "wb") as e:
            e.write(data)
        run_openssl("pkeyutl -sign -inkey t/privkey.pem " "-rawin -in t/data.txt -out t/data.sig")
...
class RFC6979(unittest.TestCase):
    ...
    def test_SECP256k1_4(self):
        self._do(
            generator=SECP256k1.generator,
            secexp=0x1,
            hsh=hashlib.sha256(b"All those moments will be lost in time, like tears in rain. Time to die...").digest(),
            hash_func=hashlib.sha256,
...
class RFC6932(ECDH):
    ...
    def test_brainpoolP384r1(self):
        self._do(
            ...
            dA=int(
                "014EC0755B78594BA47FB0A56F6173045B4331E74BA1A6F47322E70D79D" "828D97E095884CA72B73FDABD5910DF0FA76A",
                16,
            ),
            x_qA=int(
                "45CB26E4384DAF6FB776885307B9A38B7AD1B5C692E0C32F012533277" "8F3B8D3F50CA358099B30DEB5EE69A95C058B4E",
                16,
            ),
            y_qA=int(
                "8173A1C54AFFA7E781D0E1E1D12C0DC2B74F4DF58E4A4E3AF7026C5D3" "2DC530A2CD89C859BB4B4B768497F49AB8CC859",
                16,
            ),
            dB=int(
                "6B461CB79BD0EA519A87D6828815D8CE7CD9B3CAA0B5A8262CBCD550A01" "5C90095B976F3529957506E1224A861711D54",
                16,
            ),
            x_qB=int(
                "01BF92A92EE4BE8DED1A911125C209B03F99E3161CFCC986DC7711383" "FC30AF9CE28CA3386D59E2C8D72CE1E7B4666E8",
                16,
            ),
            y_qB=int(
                "3289C4A3A4FEE035E39BDB885D509D224A142FF9FBCC5CFE5CCBB3026" "8EE47487ED8044858D31D848F7A95C635A347AC",
                16,
            ),
            x_Z=int(
                "04CC4FF3DCCCB07AF24E0ACC529955B36D7C807772B92FCBE48F3AFE9A" "2F370A1F98D3FA73FD0C0747C632E12F1423EC",
                16,
            ),
            y_Z=int(
...
class RFC7027(ECDH):
    ...
    def test_brainpoolP384r1(self):
        self._do(
            ...
            generator=BRAINPOOLP384r1.generator,
            dA=int(
                "1E20F5E048A5886F1F157C74E91BDE2B98C8B52D58E5003D57053FC4B0B" "D65D6F15EB5D1EE1610DF870795143627D042",
                16,
            ),
            x_qA=int(
                "68B665DD91C195800650CDD363C625F4E742E8134667B767B1B476793" "588F885AB698C852D4A6E77A252D6380FCAF068",
                16,
            ),
            y_qA=int(
                "55BC91A39C9EC01DEE36017B7D673A931236D2F1F5C83942D049E3FA2" "0607493E0D038FF2FD30C2AB67D15C85F7FAA59",
                16,
            ),
            dB=int(
                "032640BC6003C59260F7250C3DB58CE647F98E1260ACCE4ACDA3DD869F7" "4E01F8BA5E0324309DB6A9831497ABAC96670",
                16,
            ),
            x_qB=int(
                "4D44326F269A597A5B58BBA565DA5556ED7FD9A8A9EB76C25F46DB69D" "19DC8CE6AD18E404B15738B2086DF37E71D1EB4",
                16,
            ),
            y_qB=int(
                "62D692136DE56CBE93BF5FA3188EF58BC8A3A0EC6C1E151A21038A42E" "9185329B5B275903D192F8D4E1F32FE9CC78C48",
                16,
            ),
            x_Z=int(
                "0BD9D3A7EA0B3D519D09D8E48D0785FB744A6B355E6304BC51C229FBBC" "E239BBADF6403715C35D4FB2A5444F575D4F42",
                16,
            ),
            y_Z=int(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "0BEB646634BA87735D77AE4809A0EBEA865535DE4C1E1DCB692E84708E81A5AF" "62E528C38B2A81B35309668D73524D9F",
            "96281BF8DD5E0525CA049C048D345D3082968D10FEDF5C5ACA0C64E6465A97EA" "5CE10C9DFEC21797415710721F437922",
            "447688BA94708EB6E2E4D59F6AB6D7EDFF9301D249FE49C33096655F5D502FAD" "3D383B91C5E7EDAA2B714CC99D5743CA",
            "B4B74E44D71A13D568003D7489908D564C7761E229C58CBFA18950096EB7463B" "854D7FA992F934D927376285E63414FA",
            b"abc",
            hashlib.sha384,
            "FB017B914E29149432D8BAC29A514640B46F53DDAB2C69948084E2930F1C8F7E" "08E07C9C63F2D21A07DCB56A6AF56EB3",
            "B263A1305E057F984D38726A1B46874109F417BCA112674C528262A40A629AF1" "CBB9F516CE0FA7D2FF630863A00E8B9F",
            NIST384p,
            id="ECDSA-384",
        ),
        pytest.param(
