...
class CryptPolicy(object):
    ...
    def replace(self, *args, **kwds):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.replace()``, "  # pragma: no cover -- deprecated & unused
    ...
    def has_schemes(self):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.has_schemes()``, "  # pragma: no cover -- deprecated & unused
    ...
    def iter_handlers(self):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.iter_handlers()``, " "use ``context.schemes(resolve=True)``.",
                DeprecationWarning,
                stacklevel=2,
            )
        else:
    ...
    def schemes(self, resolve=False):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.schemes()``, "  # pragma: no cover -- deprecated & unused
                "use ``context.schemes()``.",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    def get_handler(self, name=None, category=None, required=False):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.get_handler()``, " "use ``context.handler()``.",
                DeprecationWarning,
                stacklevel=2,
            )
        else:
    ...
    def get_options(self, name, category=None):
        ...
        if self._stub_policy:
            ...
            warn(
                _preamble + "``CryptPolicy().get_options()`` will no longer be available.",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    def handler_is_deprecated(self, name, category=None):
        ...
        if self._stub_policy:
            warn(
                _preamble + "``context.policy.handler_is_deprecated()`` will no longer be available.",
                DeprecationWarning,
                stacklevel=2,
            )
        else:
            warn(
                _preamble + "``CryptPolicy().handler_is_deprecated()`` will no longer be available.",
                DeprecationWarning,
                stacklevel=2,
            )
        if hasattr(name, "name"):
    ...
    def iter_config(self, ini=False, resolve=False):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.iter_config()``, "  # pragma: no cover -- deprecated & unused
    ...
    def to_dict(self, resolve=False):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.to_dict()``, " "use ``context.to_dict()``.",
                DeprecationWarning,
                stacklevel=2,
            )
        else:
    ...
    def to_string(self, section="passlib", encoding=None):
        ...
        if self._stub_policy:
            warn(
                _preamble + "Instead of ``context.policy.to_string()``, "  # pragma: no cover -- deprecated & unused
...
class _CryptConfig(object):
            ...
            if scheme:
                ...
                if scheme == "all" and key not in _global_settings:
                    warn(
                        ...
                        "globally in the context; This will be an error in Passlib 2.0" % (key,),
    ...
    def _norm_context_option(self, cat, key, value):
        ...
        if key == "default":
            ...
            warn(
                "'min_verify_time' was deprecated in Passlib 1.6, is " "ignored in 1.7, and will be removed in 1.8",
                DeprecationWarning,
            )
        elif key == "harden_verify":
            warn(
                "'harden_verify' is deprecated & ignored as of Passlib 1.7.1, " " and will be removed in 1.8",
                DeprecationWarning,
            )
        elif key != "schemes":
...
class CryptContext(object):
    ...
    policy = property(
        _get_policy, _set_policy, doc="[deprecated] returns CryptPolicy instance " "tied to this CryptContext"
    )
