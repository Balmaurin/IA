...
from passlib.utils.compat import unicode, u, join_byte_values, join_byte_elems, iter_byte_values, uascii_to_str
...
class cisco_type7(uh.GenericHandler):
    ...
    def _cipher(cls, data, salt):
        ...
        return join_byte_values(
            value ^ ord(key[(salt + idx) % key_size]) for idx, value in enumerate(iter_byte_values(data))
        )
