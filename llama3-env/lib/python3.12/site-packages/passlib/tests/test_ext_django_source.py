    ...
    if source_path:
        ...
        try:
            ...
            raise suppress_cause(
                EnvironmentError(
                    "error trying to import django tests " "from source path (%r): %r" % (source_path, err)
                )
            )
        finally:
...
if test_hashers_mod:
    ...
    class HashersTest(test_hashers_mod.TestUtilsHashPass, _ExtensionSupport):
        ...
        def setUp(self):
            ...
            for attr in ["make_password", "check_password", "identify_hasher", "is_password_usable", "get_hasher"]:
            ...
            def update_schemes(**kwds):
                ...
                schemes = [
                    django_to_passlib_name(import_string(hash_path)()) for hash_path in settings.PASSWORD_HASHERS
                ]
            ...
            for attr in ["schemes", "handler", "default_scheme", "hash", "verify", "needs_update", "verify_and_update"]:
