...
from passlib.tests.test_ext_django import DJANGO_VERSION, MIN_DJANGO_VERSION, check_django_hasher_has_backend
...
class _DjangoHelper(TestCase):
    ...
    def test_90_django_reference(self):
        ...
        for secret, hash in self.iter_known_hashes():
            ...
            self.assertFalse(
                check_password("x" + secret, hash), "mangled secret=%r hash=%r incorrect verified" % (secret, hash)
            )
...
class django_pbkdf2_sha256_test(HandlerCase, _DjangoHelper):
    ...
    known_correct_hashes = [
        ...
        (UPASS_TABLE, "pbkdf2_sha256$10000$bEwAfNrH1TlQ$OgYUblFNUX1B8GfMqaCYUK/iHyO0pa7STTDdaEJBuY0="),
    ]
...
class django_bcrypt_test(HandlerCase, _DjangoHelper):
    ...
    known_correct_hashes = [
        ...
        (UPASS_TABLE, "bcrypt$$2a$05$Z17AXnnlpzddNUvnC6cZNOSwMA/8oNiKnHTHTwLlBijfucQQlHjaG"),
    ]
...
class django_bcrypt_sha256_test(HandlerCase, _DjangoHelper):
    ...
    known_correct_hashes = [
        ...
        (UPASS_LETMEIN, "bcrypt_sha256$$2a$08$NDjSAIcas.EcoxCRiArvT.MkNiPYVhrsrnJsRkLueZOoV1bsQqlmC"),
        (UPASS_TABLE, "bcrypt_sha256$$2a$06$kCXUnRFQptGg491siDKNTu8RxjBGSjALHRuvhPYNFsa4Ea5d9M48u"),
        # test >72 chars is hashed correctly -- under bcrypt these hash the same.
        (repeat_string("abc123", 72), "bcrypt_sha256$$2a$06$Tg/oYyZTyAf.Nb3qSgN61OySmyXA8FoY4PjGizjE1QSDfuL5MXNni"),
        (
