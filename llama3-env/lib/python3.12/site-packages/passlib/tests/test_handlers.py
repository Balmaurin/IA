...
from passlib.tests.utils import TestCase, HandlerCase, skipUnless, TEST_MODE, UserHandlerMixin, EncodingHandlerMixin
...
class fshp_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ("test", "{FSHP1|8|4096}MTIzNDU2NzjTdHcmoXwNc0f" "f9+ArUHoN0CvlbPZpxFi1C6RDM/MHSA=="),
        ("OrpheanBeholderScryDoubt", "{FSHP1|8|4096}GVSUFDAjdh0vBosn1GUhz" "GLHP7BmkbCZVH/3TQqGIjADXpc+6NCg3g=="),
        (
            "ExecuteOrder66",
        ...
        #
        # ensures utf-8 used for unicode
        (UPASS_TABLE, "{FSHP1|16|16384}9v6/l3Lu/d9by5nznpOS" "cqQo8eKu/b/CKli3RCkgYg4nRTgZu5y659YV8cCZ68UL"),
    ]
...
class htdigest_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        # secret, user, realm
        # from RFC 2617
        (("Circle Of Life", "Mufasa", "testrealm@host.com"), "939e7578ed9e3c518a452acee763bce9"),
        # custom
...
class msdcc_test(UserHandlerMixin, HandlerCase):
    ...
    known_alternate_hashes = [
        ...
        ("B1176C2587478785EC1037E5ABC916D0", ("Asdf999", "sevans"), "b1176c2587478785ec1037e5abc916d0"),
    ]
...
class RoundupTest(TestCase):
    ...
    def test_pairs(self):
        ...
        self._test_pair(
            hash.ldap_pbkdf2_sha1, "sekrit", "{PBKDF2}5000$7BvbBq.EZzz/O0HuwX3iP.nAG3s$g3oPnFFaga2BJaX5PoPRljl4XIE"
        )
...
class sun_md5_crypt_test(HandlerCase):
    ...
    known_correct_configs = [
        ...
        ("$md5$3UqYqndY$$.................DUMMY", "this", "$md5$3UqYqndY$$6P.aaWOoucxxq.l00SS9k0"),
        ...
        ("$md5$3UqYqndY$.................DUMMY", "this", "$md5$3UqYqndY$HIZVnfJNGCPbDZ9nIRSgP1"),
    ]
