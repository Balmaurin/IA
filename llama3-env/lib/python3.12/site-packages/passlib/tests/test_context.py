...
from passlib.tests.utils import TestCase, set_file, TICK_RESOLUTION, quicksleep, time_call, handler_derived_from
...
"""
    ...
    def test_22_deprecated(self):
        ...
        self.assertRaises(TypeError, CryptContext, deprecated=[hash.md5_crypt], schemes=["md5_crypt", "des_crypt"])
        ...
        self.assertRaises(KeyError, CryptContext, schemes=["des_crypt"], deprecated=["md5_crypt"])

        # deprecating ALL schemes should cause ValueError
        self.assertRaises(ValueError, CryptContext, schemes=["des_crypt"], deprecated=["des_crypt"])
        self.assertRaises(
            ValueError,
            CryptContext,
        ...
        self.assertRaises(
            ValueError, CryptContext, schemes=["des_crypt", "md5_crypt"], default="md5_crypt", deprecated="md5_crypt"
        )
    ...
    def test_35_to_string(self):
        ...
        dump = ctx3.to_string()
        self.assertRegex(dump, r"# NOTE: the 'unsalted_test_hash' handler\(s\)" r" are not registered with Passlib")
