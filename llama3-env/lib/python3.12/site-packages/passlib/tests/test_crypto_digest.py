...
class Pbkdf2Test(TestCase):
    ...
    pbkdf2_test_vectors = [
        ...
        #
        # test case 1 / 128 bit
        (hb("cdedb5281bb2f801565a1122b2563515"), b"password", b"ATHENA.MIT.EDUraeburn", 1, 16),
        # test case 2 / 128 bit
        (hb("01dbee7f4a9e243e988b62c73cda935d"), b"password", b"ATHENA.MIT.EDUraeburn", 2, 16),
        # test case 2 / 256 bit
        (
        ...
        (
            hb("348c89dbcbd32b2f32d814b8116e84cf2b17347ebc1800181c4e2a1fb8dd53e1c" "635518c7dac47e9"),
            b"passwordPASSWORDpassword",
            b"saltSALTsaltSALTsaltSALTsaltSALTsalt",
            4096,
            40,
        ...
        (
            hb("b1d5485772e6f76d5ebdc11b38d3eff0a5b2bd50dc11f937e86ecacd0cd40d1b" "9113e0734e3b76a3"),
            b"secret",
            b"salt",
            62,
            40,
        ...
        (
            hb("ea014cc01f78d3883cac364bb5d054e2be238fb0b6081795a9d84512126e3129" "062104d2183464c4"),
            b"secret",
            b"salt",
            62,
            40,
