...
class TotpTest(TestCase):
    ...
    def test_from_source(self):
        ...
        # uri (bytes)
        otp = from_source(b"otpauth://totp/Example:alice@google.com?secret=JBSWY3DPEHPK3PXP&" b"issuer=Example")
        self.assertEqual(otp.key, KEY4_RAW)
    ...
    def test_from_uri(self):
        ...
        # undecodable secret
        self.assertRaises(
            Base32DecodeError, from_uri, "otpauth://totp/Example:alice@google.com?" "secret=JBSWY3DPEHP@3PXP"
        )
        ...
        self.assertRaises(
            ValueError, TOTP.from_uri, "otpauth://totp/Provider1:alice?secret=JBSWY3DPEHPK3PXP&issuer=Provider2"
        )
        ...
        # unknown alg
        self.assertRaises(
            ValueError, from_uri, "otpauth://totp/Example:alice@google.com?" "secret=JBSWY3DPEHPK3PXP&algorithm=SHA333"
        )
        ...
        self.assertRaises(
            ValueError, from_uri, "otpauth://totp/Example:alice@google.com?secret=JBSWY3DPEHPK3PXP&digits=A"
        )
        self.assertRaises(
            ValueError, from_uri, "otpauth://totp/Example:alice@google.com?secret=JBSWY3DPEHPK3PXP&digits=%20"
        )
        self.assertRaises(
            ValueError, from_uri, "otpauth://totp/Example:alice@google.com?secret=JBSWY3DPEHPK3PXP&digits=15"
        )
        ...
        # reject period < 1
        self.assertRaises(
            ValueError, from_uri, "otpauth://totp/Example:alice@google.com?" "secret=JBSWY3DPEHPK3PXP&period=0"
        )

        self.assertRaises(
            ValueError, from_uri, "otpauth://totp/Example:alice@google.com?" "secret=JBSWY3DPEHPK3PXP&period=-1"
        )
    ...
    def test_to_uri(self):
        ...
        self.assertEqual(
            ...
            "otpauth://totp/Example%20Org:alice@google.com?secret=JBSWY3DPEHPK3PXP&" "issuer=Example%20Org",
        )
        ...
        self.assertEqual(
            ...
            "otpauth://totp/alice@google.com?secret=JBSWY3DPEHPK3PXP&" "algorithm=SHA256",
        )
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(
            otp.to_dict(), dict(v=1, type="totp", key=KEY4, label="alice@google.com", issuer="Example Org")
        )
