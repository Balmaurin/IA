    ...
    def _calc_checksum(self, secret):
        ...
        if wrapper_cls is None:
            ...
            wrapper_cls = cls.__cc_compat_hack = type(
                cls.__name__ + "_wrapper", (cls,), dict(_calc_checksum=inner, __module__=cls.__module__)
            )
    ...
    def using(
        ...
        **kwds,
        ...
        if vary_rounds is not None:
            ...
            if vary_rounds:
                warn(
                    "The 'vary_rounds' option is deprecated as of Passlib 1.7, " "and will be removed in Passlib 2.0",
...
class HasManyBackends(BackendMixin, GenericHandler):
    ...
    def _get_backend_loader(cls, name):
        ...
        if loader is None:
            ...
            ), "%s: can't specify both ._load_backend_%s() " "and ._has_backend_%s" % (cls.name, name, name)
        return loader
